...
$connUser = conectar();
$stmt = $connUser->prepare("SELECT u.NOMBRE, u.CORREO, p.T_PLAN AS PLAN, p.F_EXPIRACION AS FECHA_EXPIRACION FROM usuarios u JOIN plan p ON u.ID = p.ID WHERE u.CORREO = ?");
